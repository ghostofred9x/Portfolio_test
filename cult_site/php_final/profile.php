...
// Connects to your Database
	...
	if(isset($_COOKIE['ID_my_site']))  {
		...
		$check = mysql_query("SELECT * FROM pjl_users WHERE username = '$username'")or die(mysql_error());
...
<head>
<title>
Calming Wake: <?php echo $username; ?>'s Profile
</title>
...
</div><div id="login"><a href="logout.php">Logout?</a></div>
</div>
...
<div id="content">
<div id="left_panel">
<p>Welcome back <?php echo $username; ?>!
</p>
<p> We are so glad that you decided to return, we missed you.</p>
<p> We hope that you don't mind that we have taken the liberty to create a profile for you.</p>
<p>We thought of a few better things that we thought were more fitting for you to be able to assimulate into our
society. We just want you to feel at home, be nice and rested, and be a part of our ever growing list of contributors!</p>
</div>
<div id="right_panel">
<p>This is where your profile information would go, but you won't need to upload an image, we will take the liberty for you, we have plenty of pictures of you, and now that you created this profile, we know where you are, and we are coming for you!</p>
